...
class SyncSwap(BaseDex):
  ...
  },
  {
    ...
    lpts = [
        EVMToken("ETH:USDT", "0x78ea8E533c834049dE625e05F0B4DeFfe9DB5f6e", 18, "scroll"),
        EVMToken("ETH:USDC", "0x814A23B053FD0f102AEEda0459215C2444799C70", 18, "scroll"),
        EVMToken("USDT:USDC", "0x2076d4632853FB165Cf7c7e7faD592DaC70f4fe1", 18, "scroll"),
   ]
    name_from_contract = {
