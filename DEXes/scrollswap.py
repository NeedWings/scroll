...
class ScrollSwap(BaseDex):
    ...
    lpts = [
        EVMToken("ETH:USDT", "0xE3c46d28C23007B0BfF7Bb58471C81312C0A8690", 18, "scroll"),
   ]
    ...
    def create_txn_for_remove_liq(self, lptoken: EVMToken, sender: BaseAccount):
        ...
        stable = token1.stable and token2.stable
        token1_val = token1.get_balance(lptoken.contract_address, w3=w3, of_wrapped=True)[0]
        token2_val = token2.get_balance(lptoken.contract_address, w3=w3, of_wrapped=True)[0]
        deadline = int(time.time()+3600)
        ...
        liq_amount = lptoken.get_balance(sender.get_address(), w3=w3)[0]
        ...
        msg = {
            ...
            'message': {
                ...
                'value': int(lptoken.get_balance(sender.get_address(), w3=w3)[0]),
