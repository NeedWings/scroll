...
class Skydrome(BaseDex):
    ...
    lpts = [
        EVMToken("ETH:USDT", "0x82B8b66CeC3668558AFb66Bcdd83b35E010b39a7", 18, "scroll"),
        EVMToken("ETH:USDC", "0x1d675222304d1c09370A3922F46B63d6024ea768", 18, "scroll"),
        EVMToken("USDT:USDC", "0xa631B2A2C3469aa1bF5dc49977207F378D16d7d8", 18, "scroll"),
   ]
